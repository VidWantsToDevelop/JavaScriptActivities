...
*/
var storyText = "Unusual weather, around 94 farenheit outside.... Bright streets of :insertB: were :insertC: so :insertA: decided to do some coding. He has roasted some chestnuts, brewed a fresh cup of coffee, and enjoyed the rest of his day writing code in :insertD:. In a meanwhile, he has found that the average weight of a mature tiger is ~440 pounds, and the average weight of a mature lion is also ~440 pounds."
...
*/
var insertA = ["David", "John", "Cristopher"]
var insertB = ["New York", "Los Angeles", "Chicago"]
var insertC = ["too cold to go anywhere", "too hot to go anywhere", "too rainy to go anywhere"]
var insertD = ["JavaScript", "Python", "C"]

var allInserts = [insertA, insertB, insertC, insertD]
...
function result() {
    ...
    var dItem = randomValueFromArray(insertD);
    ...
    if (customName.value != "") {
        newStory = newStory.replace(aItem, customName.value)
    }
    ...
    if (document.getElementById("metric").checked) {
        // STEP 11a: Create a variable called weight and convert the 440lbs to kgs (1lb = 0.453592kg)
        var metricWeight = 440 * 0.453592;
        // STEP 11b: Replace the string 300 pounds with the updated weight in kg
        newStory = newStory.replaceAll("440 pounds", metricWeight.toFixed(2) + " killograms")
        // STEP 12a: Create a variable called temp and convert °F to °C ... the formula for conversion is °C = (°F - 32) x 5/9
        var metricTemp = (94 - 32) * 5 / 9;
        // STEP 12b: Replace the string '94 fahrenheit' with the updated temperature in °C
        newStory = newStory.replace("94 farenheit", metricTemp.toFixed(2) + " celsius")
    }
